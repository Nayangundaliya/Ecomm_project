                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ $brand->name}}" placeholder="Enter Brand">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="slug" value="{{ $brand->slug}}" placeholder="Enter slug">
                                        <span class="text-danger">
                                            @error('slug')
                                            {{ $message }}
                                            @enderror
