                            ...
                            <tbody class="bg-white">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <a id="" class="btn btn-primary" href="{{ url('/admin/order/edit') }}/{{ $data->id }}" role="button"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        <a id="" class="btn btn-danger" href="{{ url('/admin/order/destory') }}/{{ $data->id }}" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </div>
                                </td>
                                </tr>
                                @endforeach --}}
