            ...
            <div class="col-12 ">
                <div class="card">
                    ...
                    <div class="card-header d-flex flex-row-reverse">
                        <div>
                            {{-- <a class="btn btn-primary" href="{{ url('/admin/customer/create') }}" role="button"><i class="fa fa-plus" aria-hidden="true">&nbsp&nbsp</i> Add Customer </i></a>
                            &nbsp&nbsp --}}
                        ...
                        <table class="table container table-hover text-center">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="{{url('/')}}/admin/customer/status/1/{{$data->status}}">

                                    <span class="role admin">Deactive</span>
                                    </a>
                                    </td>
                                    @else
                                    <td>
                                        <a class="btn btn-primary" href="{{url('/')}}/admin/customer/status/0/{{$data->status}}">
